...
export function EventSec({organizationalEvents}:{organizationalEvents:Event[]}) {
  const cards = organizationalEvents.map((event, index) => (
  ...
  return (
    <div id="organizational-events" className="w-full h-full">
      ...
      {organizationalEvents.length ===0 && <NoEvents eventType="Organizational" />}
