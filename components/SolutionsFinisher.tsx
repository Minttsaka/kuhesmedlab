      ...
      <div className='container mx-auto'>
        <div className='grid md:grid-cols-2 gap-5'>
            <div className='space-y-6'>
                <h2 className=' font-bold'>Lorem ipsum dolor sit amet consectetur adipisicing.</h2>
            ...
            <div className='space-y-6'>
                ...
                <div className='space-y-6'>
                    <ul className='space-y-5'>
                        <li className="font-bold border-s-2 border-s-gray-500 pl-4">Retail and ecommerce</li>
                        <li className="font-bold border-s-2 border-s-gray-500 pl-4">finance and banking</li>
                        <li className="font-bold border-s-2 border-s-gray-500 pl-4">health and fitness</li>
                        <li className="font-bold border-s-2 border-s-gray-500 pl-4">Education and learning</li>
                    </ul>
                    <p className='border-s-4  font-light border-s-green-500 pl-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste sapiente maiores quidem iusto ipsam, voluptas architecto distinctio molestias neque. Inventore. Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere ab, quo eveniet pariatur numquam dolore magnam nam odio! Minima, ducimus?</p>
