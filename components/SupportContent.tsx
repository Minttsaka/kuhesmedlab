...
import { ChevronRight, Home, FileText, HelpCircle, Settings, ExternalLink, Search } from 'lucide-react'
    ...
    <div className="flex flex-col h-screen bg-gray-100">
      ...
      <div className="bg-white border-b border-gray-200 p-4">
        <div className="max-w-7xl mx-auto flex items-center">
          <h1 className="text-2xl font-bold text-gray-800 mr-4">Kuhesmedlab Support</h1>
