...
export default function GlobalConnection() {
  return (
    <div className='relative min-h-screen'>
      <div className=' -skew-y-12  h-[30rem] bg-[#2a2e7c] origin-top-left ' />
      <div className='absolute inset-x-0 top-16   h-[30rem] bg-[#2a2e7c] origin-top-left ' />
      <div className='   h-[25rem] bg-[#2a2e7c] origin-top-left ' />
