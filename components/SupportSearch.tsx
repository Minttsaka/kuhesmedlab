...
export default function SupportSearch({supportList, searchQuery }:{searchQuery:string | string[] | undefined, supportList:Support[]}) {
              ...
              <li key={result.id}>
                <Card>
                  <CardContent className="pt-6">
                    <Link href={`/support/${result.slug}`} className="font-medium hover:underline text-lg mb-2">
