...
export function EventThird({institutionEvents}:{institutionEvents:Event[]}) {
  const cards = institutionEvents.map((event, index) => (
  ...
  return (
    <div id="institutional-events" className="w-full h-full">
      <h2 className="max-w-7xl pl-4 mx-auto text-xl md:text-5xl font-bold text-neutral-800 dark:text-neutral-200 font-sans">
        Institutional Events
      </h2>
      {institutionEvents.length ===0 && <NoEvents eventType="Institutional" />}
